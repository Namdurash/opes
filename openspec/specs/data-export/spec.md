...
## Purpose
Define how a user gets their data out of this local-only app: exporting all transactions as JSON or CSV through the system share sheet, with no file-system dependency. Empty data shows an informational message rather than sharing.
