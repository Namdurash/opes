...
describe('SettingsScreen sandbox reset row', () => {
  it('AC-014 — renders the reset item in a sandbox build', () => {
  ...
  it('AC-015 — renders no reset item in a normal build', () => {
...
describe('SettingsScreen sandbox reset navigation', () => {
  it('AC-011 — sends the app back to Welcome once the reset item is pressed', async () => {
    ...
    tree.queryAllByTestId('sandbox-reset-item').forEach(node => fireEvent.press(node));
